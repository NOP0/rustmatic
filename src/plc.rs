// TODO: Is slotmap the correct container for this, check out arrayvec. (Recent const generics evolution)
...
// TODO: Current implementation is separate data structures for each data type, consider options.
...
impl <E>ProcessImageInputs<E> where
    E: ImageEntity,
    {
 ...
 /// TODO: Poor ergonomics in user program
    pub fn get_mut(&mut self, key: <E as ImageEntity>::KeyType) -> Option<&mut E> {
